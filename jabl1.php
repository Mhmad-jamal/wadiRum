            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Jebel Al-Hash Hiking Tour </h1>
        ...
        <div class="row g-5">
            <div class="col-lg-6 wow heading-2" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid position-absolute w-100 h-100" src="img/h1New.jpeg" alt="" style="object-fit: cover;">
                </div>
            </div>
